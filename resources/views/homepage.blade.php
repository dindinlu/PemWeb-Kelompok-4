    ...
    <div class="swiper-container">
        <div>
            ...
            <section class="islands">
                <img src="{{ asset('frontend/assets/img/index.jpg') }}" alt="" class="islands__bg" />
                <div class="bg__overlay">
                    <div class="islands__container container">
                        <div class="islands__data" style="z-index: 99; position: relative; color: white; text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;">
                            <h2 class="islands__subtitle">Telusuri</h2>
                            <h1 class="islands__title">WISATA RELIGI</h1>
    ...
    <div class="value__container container grid">
        ...
        <div class="value__content">
            <div class="value__data">
                ...
                <h2 class="section__title">Pengalaman Apa Yang Akan Anda Dapatkan</h2>
            ...
            <div class="value__accordion">
                <div class="value__accordion-item">
                    <header class="value__accordion-header">
                        ...
                        <h3 class="value__accordion-title">Lokasi ziarah terbaik di berbagai dunia</h3>
                ...
                <div class="value__accordion-item">
                    <header class="value__accordion-header">
                        ...
                        <h3 class="value__accordion-title">Harga terbaik untuk anda</h3>
                        <div class="value__accordion-arrow">
                            <i class="bx bxs-down-arrow"></i>
                        </div>
                    </header>
                ...
                <div class="value__accordion-item">
                    <header class="value__accordion-header">
                        ...
                        <h3 class="value__accordion-title">Rencanakan liburan anda</h3>
                        <div class="value__accordion-arrow">
                            <i class="bx bxs-down-arrow"></i>
                        </div>
                    </header>
                    <div class="value__accordion-content">
                        <p class="value__accordion-description">Provides you with time properly.</p>
                    </div>
                </div>
                <div class="value__accordion-item">
                    <header class="value__accordion-header">
                        <i class="bx bxs-check-square value-accordion-icon"></i>
                        <h3 class="value__accordion-title">Jaminan keamanan</h3>
                        <div class="value__accordion-arrow">
                            <i class="bx bxs-down-arrow"></i>
                        </div>
                    </header>
                    <div class="value__accordion-content">
                        <p class="value__accordion-description">We make sure that our services have a good of security.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="blog section" id="blog">
    <div class="blog__container container">
        ...
        <h2 class="section__title" style="text-align: center">The Best Trip For You</h2>
        ...
        <div class="blog__content grid">
            ...
            <article class="blog__card">
                ...
                <div class="blog__data">
                    <h2 class="blog__title">{{ $blog->title }}
                 </h2>

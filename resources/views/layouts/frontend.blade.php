...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/hover-boxes.css') }}" /> <!-- Tambahkan baris ini -->

    @stack('style-alt')
    <title>Holly Crossroads</title>
</head>
<body>
    <!--==================== HEADER ====================-->
    <header class="header" id="header">
        <nav class="nav container">
            <a href="#home" class="nav__logo">
                <img src="/frontend/assets/img/LOGO.png" alt="Travel Logo" style="height: 250px; width: auto;">
            </a>
            <div class="nav__menu">
                <ul class="nav__list">
                    <li class="nav__item">
